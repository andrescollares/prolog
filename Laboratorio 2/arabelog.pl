...
%Obtiene todos los movimientos posibles y busca la mejor jugada con profundidad nivel - 1.
...
%Alpha = max(Alpha, minimax(child,...)), minimax > Alpha. return minimax
%Beta = min(Beta, minimax(child,...)), minimax < Beta. return minimax 
...
%Alpha = max(Alpha, minimax(child,...)), minimax < Alpha. return Alpha
%Beta = min(Beta, minimax(child,...)), minimax > Beta. return Beta
